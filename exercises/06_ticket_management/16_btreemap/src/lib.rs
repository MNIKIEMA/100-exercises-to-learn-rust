...
impl IntoIterator for &TicketStore {
    ...
    type IntoIter = std::collections::btree_map::Values<'static, TicketId, Ticket>;

    fn into_iter(self) -> Self::IntoIter {
        let store_static = unsafe { std::mem::transmute::<&TicketStore, &'static TicketStore>(self) };
        store_static.tickets.values()
    }
}
